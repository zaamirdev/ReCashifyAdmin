...
export default async function SellDraftDetailsPage({
    params,
}: {
    params: Promise<{
        id: string;
                    ...
                    <div className="mt-6 rounded-[var(--radius-lg)] border border-[var(--border-default)] bg-[var(--bg-surface)] p-5">
                        ...
                        <div className="mt-5 grid gap-4">
                            <JsonCard
                                ...
                                data={draft.screen_condition}
                            />

                            <JsonCard
                                title="Body Condition"
                                data={draft.body_condition}
                            />

                            <JsonCard
                                title="Functional Issues"
                                data={draft.functional_issues}
                            />
                        </div>
                    </div>
